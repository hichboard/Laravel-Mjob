...
@section('content')
        ...
        <div id="space_candida">
            ...
            {{ csrf_field() }}
                ...
                <table class="register-tbl">
                    <tr>
                        <th><label class="label-jb" for="first_name">Nom :</label></th>
                        <th><label class="label-jb" for="last_name">Prénom :</label></th>
                    </tr>
                    <tr>
                        <th>
                            <input value="{{old('first_name')}}" minlength="3" class="input-jb" id="first_name" name="first_name" type="text" required>
                        ...
                        <th>
                            <input value="{{old('last_name')}}" minlength="3" class="input-jb" id="last_name" name="last_name" type="text" required>
                    ...
                    <tr>
                        <th><label  class="label-jb" for="password-confirm">{{ __('Confirmez le mot de passe') }}</label></th>
                        <th><label  class="label-jb" for="phone">{{ __('Télé') }}</label></th>
                    </tr>
                    <tr>
                        <th>
                            <input class="input-jb"  id="password-confirm" type="password" name="password_confirmation" required>
                        ...
                        <th>
                            <input value="{{old('phone')}}" maxlength="10" minlength="10" class="input-jb" id="phone" name="phone" type="tel" required>
                            @if ($errors->has('phone'))
                                <div class="uk-alert-danger">
                    ...
                    <tr>
                        <th>
                            <input class="" id="box-pass-register" name="box-pass-register" type="checkbox">
                            <label class="label-jb" onclick="tpc()" for="box-pass-register">Afficher le mot de passe</label>
                        </th>
                    ...
                    <tr>
                        ...
                        <th style="float: right"><button style="width: 130px;height: 30px"  class="btn-jb" type="submit">{{ __('Enregistrer') }}</button>
            ...
            <form action="{{url('mjobs')}}" method="post" enctype="multipart/form-data">
                ...
                <table class="register-tbl">
                    ...
                    <tr>
                        ...
                        <th><button name="brn-emp-reg" class="uk-button uk-button-primary"  type="submit">Enregistrer</button>
                            <p class="content-panel"  >J'ai déjà un compte.
                                <a style="display: inline;font-size: 15px ;" href="{{url('/login')}}#drg">S'identifier</a>
                            </p>
                        </th>
    ...
    <script>
        ...
        function tpc() {
            ...
            var b = document.getElementById("password-confirm");
